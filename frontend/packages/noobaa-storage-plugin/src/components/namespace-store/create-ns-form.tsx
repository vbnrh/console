  ...
  return (
    <>
      {provider === BC_PROVIDERS.AWS && (
        <FormGroup label="Region" fieldId="region" className="nb-ns-form-entry" isRequired>
          <Dropdown
      ...
      {endpointSupported.includes(provider) && (
        <FormGroup label="Endpoint" fieldId="endpoint" className="nb-ns-form-entry" isRequired>
          <TextInput
            onChange={(e) => {
  ...
  return (
    <>
      <FormGroup
        ...
        fieldId="set-volumes"
        className="nb-ns-form-entry nb-ns-form-entry--short"
        isRequired
      >
        <InputGroup>
          <InputGroupText>
      ...
      <FormGroup fieldId="storage-class" className="nb-ns-form-entry" isRequired>
...
const GCPEndpointType: React.FC<GCPEndPointTypeProps> = (props) => {
  ...
  return (
    <>
      ...
      >
        <InputGroup>
          <TextInput
            isReadOnly
            value={inputData}
            className="nb-ns-form-entry__file-name"
            placeholder="Upload JSON"
            aria-label="Uploaded File Name"
          />
          <div className="inputbtn nb-ns-form-entry-upload-btn">
            <Button
              href="#"
              variant="secondary"
              className="custom-input-btn nb-ns-form-entry-upload-btn__button"
            >
              Browse
            </Button>
            <input
              type="file"
              id="inputButton"
              className="nb-ns-form-entry-upload-btn__input"
              onChange={onUpload}
      ...
      <FormGroup className="nb-ns-form-entry" helperText={gcpHelpText} fieldId="gcp-data">
        <TextArea
          aria-label="cluster-metadata"
          className="nb-ns-form-entry__data-dump"
          value={fileData}
        />
      </FormGroup>
      <FormGroup
...
>((props) => {
  ...
  const onSubmit = (event) => {
    ...
    promises.push(k8sCreate(NooBaaNamespaceStoreModel, bsPayload));
  ...
  return (
    <Form className={classNames('nb-ns-form', className)} onSubmit={onSubmit}>
      ...
      <FormGroup label="Provider" fieldId="provider-name" className="nb-ns-form-entry" isRequired>
        <Dropdown
          className="nb-ns-form-entry__dropdown"
          buttonClassName="nb-ns-form-entry__dropdown"
